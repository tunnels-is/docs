...
```
Purpose: VPN server verifies control server signatures<br/>
Content: control server's public key/certificate<br/>
Used When: Control and VPN are separate servers<br/>
...
**Algorithm**: TOTP (Time-Based One-Time Password)<br/>
**Library**: `github.com/xlzd/gotp`<br/>
**Backup Codes**: Recovery codes for account access<br/>
...
After authentication, the control server signs connection requests (`server/handlers.go:1131-1217`):
